...
export type Security_PatchActionGroup_RequestBody = Security_CommonPatchOperation.undefined[]

export type Security_PatchActionGroup_Response = ApiResponse & {
  body: Security_PatchActionGroup_ResponseBody;
}

export type Security_PatchActionGroup_ResponseBody = Security_CommonOk.undefined
