...
- Rename `opensearchtypes` to `opensearchTypes` due to the inconsistency with CamelCase naming convention in OSD ([#433](https://github.com/opensearch-project/opensearch-js/pull/433))
