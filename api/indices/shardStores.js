 ...
 * @param {string} [params.status=yellow,red] - A list of shard health statuses used to limit the request.
 * @param {string} [params.index] - Limits health reporting to a specific source. Can be a single source or a comma-separated list of sources (comprised of data streams, indexes, and aliases).
 *
