...
const { giveAwsV4Signer, loadAwsCredentialProvider } = require('./shared');
...
const AwsSigv4Signer = giveAwsV4Signer(loadAwsCredentialProvider(getAwsSDKCredentialsProvider));
