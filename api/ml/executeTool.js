...
/**
 * Execute a tool.
 * <br/> See Also: {@link undefined - ml.execute_tool}
 *
 * @memberOf API-Ml
 *
 * @param {object} params
 ...
 */
function executeToolFunc(params, options, callback) {
  ...
  const path = '/_plugins/_ml/tools/_execute/' + tool_name;
  const method = 'POST';
  body = body || '';
...
module.exports = executeToolFunc;
