 ...
 * <br/> See Also: {@link https://docs.opensearch.org/latest/api-reference/cluster-api/cluster-stats/ - cluster.stats}
 *
 ...
 * @param {array} [params.index_metric] - A comma-separated list of [index metric groups](https://docs.opensearch.org/latest/api-reference/cluster-api/cluster-stats/#index-metric-groups), for example, `docs,store`.
 * @param {array} [params.metric] - Limit the information returned to the specified metrics.
 * @param {string} [params.node_id] - A comma-separated list of node IDs used to filter results. Supports [node filters](https://docs.opensearch.org/latest/api-reference/nodes-apis/index/#node-filters).
 *
