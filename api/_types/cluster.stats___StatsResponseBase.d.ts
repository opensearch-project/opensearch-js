...
import * as Cluster_StatsClusterIndices from './cluster.stats___ClusterIndices'
import * as Cluster_StatsClusterNodes from './cluster.stats___ClusterNodes'
...
export type undefined = Nodes_CommonNodesResponseBase.undefined & {
  ...
  indices: Cluster_StatsClusterIndices.undefined;
  nodes: Cluster_StatsClusterNodes.undefined;
