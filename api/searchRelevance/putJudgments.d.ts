...
export type SearchRelevance_PutJudgments_RequestBody = SearchRelevance_Common.PutLLMJudgmentsRequest | SearchRelevance_Common.PutUBIJudgmentsRequest | SearchRelevance_Common.PutImportJudgmentsRequest

export interface SearchRelevance_PutJudgments_Response extends ApiResponse {
  body: SearchRelevance_PutJudgments_ResponseBody;
}

export type SearchRelevance_PutJudgments_ResponseBody = SearchRelevance_Common.PutJudgmentsResponse
