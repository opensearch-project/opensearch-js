...
export type IndicesRecord = {
  ...
  last_index_request_timestamp?: undefined | string;
  last_index_request_timestamp_string?: undefined | string;
  'memory.total'?: string;
  ...
  'merges.warmer.ongoing_count'?: undefined | string;
  'merges.warmer.total_bytes_received'?: undefined | string;
  'merges.warmer.total_bytes_sent'?: undefined | string;
  'merges.warmer.total_failure_count'?: undefined | string;
  'merges.warmer.total_invocations'?: undefined | string;
  'merges.warmer.total_receive_time'?: undefined | string;
  'merges.warmer.total_send_time'?: undefined | string;
  'merges.warmer.total_time'?: undefined | string;
  pri?: string;
  ...
  'pri.merges.warmer.ongoing_count'?: undefined | string;
  'pri.merges.warmer.total_bytes_received'?: undefined | string;
  'pri.merges.warmer.total_bytes_sent'?: undefined | string;
  'pri.merges.warmer.total_failure_count'?: undefined | string;
  'pri.merges.warmer.total_invocations'?: undefined | string;
  'pri.merges.warmer.total_receive_time'?: undefined | string;
  'pri.merges.warmer.total_send_time'?: undefined | string;
  'pri.merges.warmer.total_time'?: undefined | string;
  ...
  'pri.search.query_failed'?: undefined | string;
  ...
  'pri.search.startree_query_failed'?: undefined | string;
  'pri.search.startree.query_current'?: undefined | string;
  'pri.search.startree.query_time'?: undefined | string;
  'pri.search.startree.query_total'?: undefined | string;
  ...
  'search.query_failed'?: undefined | string;
  ...
  'search.startree_query_current'?: undefined | string;
  'search.startree_query_failed'?: undefined | string;
  'search.startree_query_time'?: undefined | string;
  'search.startree_query_total'?: undefined | string;
