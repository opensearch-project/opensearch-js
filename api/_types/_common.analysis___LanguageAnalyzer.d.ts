...
import * as Common_AnalysisLanguage from './_common.analysis___Language'
...
export type undefined = {
  language: Common_AnalysisLanguage.undefined;
  stem_exclusion: string[];
  stopwords?: Common_AnalysisStopWords.undefined;
