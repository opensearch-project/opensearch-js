...
function SearchRelevanceApi(bindObj) {
  ...
  this.deleteScheduledExperiments = require('./deleteScheduledExperiments').bind(bindObj);
  ...
  this.getScheduledExperiments = require('./getScheduledExperiments').bind(bindObj);
  ...
  this.postScheduledExperiments = require('./postScheduledExperiments').bind(bindObj);
  ...
  this.delete_scheduled_experiments = require('./deleteScheduledExperiments').bind(bindObj);
  ...
  this.get_scheduled_experiments = require('./getScheduledExperiments').bind(bindObj);
  ...
  this.post_scheduled_experiments = require('./postScheduledExperiments').bind(bindObj);
