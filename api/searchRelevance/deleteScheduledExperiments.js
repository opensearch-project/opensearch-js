 ...
 * <br/> See Also: {@link undefined - search_relevance.delete_scheduled_experiments}
 *
 ...
 */
function deleteScheduledExperimentsFunc(params, options, callback) {
  ...
  const path = '/_plugins/_search_relevance/experiments/schedule/' + experiment_id;
  const method = 'DELETE';
  body = body || '';
...
module.exports = deleteScheduledExperimentsFunc;
