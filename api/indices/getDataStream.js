 ...
 *
 * @param {object} [params]
 * @param {string} [params.name] - A comma-separated list of data stream names used to limit the request. Wildcard (`*`) expressions are supported. If omitted, all data streams are returned.
 *
