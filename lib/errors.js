...
class NotCompatibleError extends ElasticsearchClientError {
  constructor (meta) {
    super('Not Compatible Error')
    Error.captureStackTrace(this, NotCompatibleError)
    this.name = 'NotCompatibleError'
    this.message = 'The client noticed that the server is not a supported distribution of Elasticsearch'
    this.meta = meta
  }
}
