 ...
 * @param {string} [params.node_id] - Comma-separated list of node IDs or names to limit the returned information; leave empty to get information from all nodes.
 * @param {string} [params.stat] - Comma-separated list of stats to retrieve; use empty string to retrieve all stats.
 *
