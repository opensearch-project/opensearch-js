...
import * as CommonBulkByScrollTaskStatusOrException from './_common___BulkByScrollTaskStatusOrException'
...
export type undefined = {
  ...
  slice_id?: number;
  slices?: CommonBulkByScrollTaskStatusOrException.undefined[];
