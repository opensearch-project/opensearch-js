 ...
 * @param {string} [params.expand_wildcards] - The type of index that wildcard patterns can match. If the request can target data streams, this argument determines whether wildcard expressions match hidden data streams. Supports comma-separated values, such as `open,hidden`.
 * @param {string} [params.fields] - A comma-separated list of fields to retrieve capabilities for. Wildcard (`*`) expressions are supported.
