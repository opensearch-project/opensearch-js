 ...
 * <br/> See Also: {@link undefined - ml.predict_model_stream}
 *
 * @memberOf API-Ml
 *
 * @param {object} params
 ...
 */
function predictModelStreamFunc(params, options, callback) {
  ...
  const path = '/_plugins/_ml/models/' + model_id + '/_predict/stream';
  const method = 'POST';
  body = body || '';
...
module.exports = predictModelStreamFunc;
