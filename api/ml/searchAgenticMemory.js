 ...
 * <br/> See Also: {@link undefined - ml.search_agentic_memory}
 *
 * @memberOf API-Ml
 *
 * @param {object} params
 ...
 */
function searchAgenticMemoryFunc(params, options, callback) {
  ...
  const path = '/_plugins/_ml/memory_containers/' + memory_container_id + '/memories/' + type + '/_search';
  const method = 'GET';
  body = body || '';
...
module.exports = searchAgenticMemoryFunc;
