...
import * as Common_AggregationsHoltWintersModelSettings from './_common.aggregations___HoltWintersModelSettings'
...
export type undefined = Common_AggregationsMovingAverageAggregationBase.undefined & {
  model: 'holt_winters';
  settings: Common_AggregationsHoltWintersModelSettings.undefined;
}
