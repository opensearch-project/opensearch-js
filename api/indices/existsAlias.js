 ...
 * @param {boolean} [params.ignore_unavailable] - If `false`, requests that include a missing data stream or index in the target indices or data streams return an error.
