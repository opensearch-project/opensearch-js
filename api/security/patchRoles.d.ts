...
export type Security_PatchRoles_RequestBody = Security_CommonPatchOperation.undefined[]

export type Security_PatchRoles_Response = ApiResponse & {
  body: Security_PatchRoles_ResponseBody;
}

export type Security_PatchRoles_ResponseBody = Security_CommonOk.undefined
