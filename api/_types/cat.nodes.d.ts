...
export type NodesRecord = {
  ...
  'merges.warmer.ongoing_count'?: string;
  'merges.warmer.total_bytes_received'?: string;
  'merges.warmer.total_bytes_sent'?: string;
  'merges.warmer.total_failure_count'?: string;
  'merges.warmer.total_invocations'?: string;
  'merges.warmer.total_receive_time'?: string;
  'merges.warmer.total_send_time'?: string;
  'merges.warmer.total_time'?: string;
  name?: Common.Name;
  'node.role'?: string;
  'node.roles'?: string;
  pid?: string;
  ...
  'search.query_failed'?: string;
  'search.query_time'?: string;
  'search.query_total'?: string;
  'search.scroll_current'?: string;
  'search.scroll_time'?: string;
  'search.scroll_total'?: string;
  'search.startree_query_current'?: string;
  'search.startree_query_failed'?: string;
  'search.startree_query_time'?: string;
  'search.startree_query_total'?: string;
