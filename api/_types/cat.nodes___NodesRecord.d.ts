...
export type undefined = {
  ...
  'disk.total'?: string;
  'disk.used'?: string;
  'disk.used_percent'?: CommonPercentageString.undefined;
  'fielddata.evictions'?: string;
  'fielddata.memory_size'?: string;
  'file_desc.current'?: string;
  'file_desc.max'?: string;
  'file_desc.percent'?: CommonPercentageString.undefined;
  flavor?: string;
  'flush.total'?: string;
  ...
  'heap.current'?: string;
  'heap.max'?: string;
  'heap.percent'?: CommonPercentageString.undefined;
  http_address?: string;
  ...
  'ram.current'?: string;
  'ram.max'?: string;
  'ram.percent'?: CommonPercentageString.undefined;
