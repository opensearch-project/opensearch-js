...
export type Security_PatchRoleMapping_RequestBody = Security_CommonPatchOperation.undefined[]

export type Security_PatchRoleMapping_Response = ApiResponse & {
  body: Security_PatchRoleMapping_ResponseBody;
}

export type Security_PatchRoleMapping_ResponseBody = Security_CommonOk.undefined
