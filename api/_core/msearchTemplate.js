 ...
 * <br/> See Also: {@link https://docs.opensearch.org/latest/search-plugins/search-template/ - msearch_template}
 *
 * @memberOf API-Core
 *
 * @param {object} params
 ...
 * @param {string} [params.index] - A comma-separated list of data streams, indexes, and aliases to search. Supports wildcards (`*`). To search all data streams and indexes, omit this parameter or use `*`.
