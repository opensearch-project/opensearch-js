...
import * as Common_AggregationsDateRangeExpression from './_common.aggregations___DateRangeExpression'
...
export type undefined = Common_AggregationsBucketAggregationBase.undefined & {
  ...
  ranges?: Common_AggregationsDateRangeExpression.undefined[];
